...
python main.py --exp_name coach_chunk  --exp_id br_0 --bidirection --freeze_emb  --tgt_dm BookRestaurant


# python main.py --exp_name coach_no_tr --exp_id atp_0 --bidirection --freeze_emb  --tgt_dm AddToPlaylist
# python main.py --exp_name coach_tr --exp_id br_0 --bidirection --tr --freeze_emb  --tgt_dm BookRestaurant --emb_file coachdata/snips/emb/slu_word_char_embs_with_slotembs.npy
