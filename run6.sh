...
python main.py --exp_name coach_encode_slotname  --exp_id sse_0 --bidirection --freeze_emb  --tgt_dm SearchScreeningEvent --tr --emb_file  /home/sh/data/coachdata/snips/emb/slu_word_char_embs_with_slotembs.npy
...
# python main.py --exp_name coach_tr --exp_id sse_0 --bidirection --freeze_emb --tr  --tgt_dm SearchScreeningEvent --emb_file coachdata/snips/emb/slu_word_char_embs_with_slotembs.npy
