...
python main.py --exp_name coach_encode_slotname  --exp_id rb_0 --bidirection --freeze_emb  --tgt_dm RateBook --tr --emb_file  /home/sh/data/coachdata/snips/emb/slu_word_char_embs_with_slotembs.npy
...
# python main.py --exp_name coach_tr --exp_id rb_0 --bidirection --tr --freeze_emb  --tgt_dm RateBook --emb_file coachdata/snips/emb/slu_word_char_embs_with_slotembs.npy
