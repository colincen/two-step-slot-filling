...
python main.py --exp_name coach_chunk  --exp_id sc_0 --bidirection --freeze_emb  --tgt_dm SearchCreativeWork 
...
# python main.py --exp_name coach_tr --exp_id sc_0 --bidirection --tr --freeze_emb  --tgt_dm SearchCreativeWork --emb_file coachdata/snips/emb/slu_word_char_embs_with_slotembs.npy
