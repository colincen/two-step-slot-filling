...
python main.py --exp_name coach_encode_slotname  --exp_id pm_0 --bidirection --freeze_emb  --tgt_dm PlayMusic --tr --emb_file  /home/sh/data/coachdata/snips/emb/slu_word_char_embs_with_slotembs.npy
