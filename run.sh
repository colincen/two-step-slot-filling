...
python main.py --exp_name coach_chunk  --exp_id atp_0 --bidirection --freeze_emb  --tgt_dm AddToPlaylist 


# python main.py --exp_name coach_tr --tr --exp_id atp_0 --bidirection --freeze_emb  --tgt_dm AddToPlaylist --emb_file coachdata/snips/emb/slu_word_char_embs_with_slotembs.npy
