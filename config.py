...
def get_params():
    ...
    parser.add_argument("--emb_file", type=str, default="/data/sh/coachdata/snips/emb/slu_word_char_embs.npy", help="embeddings file")  # slu_embs.npy w/o char embeddings   slu_word_char_embs.npy w/ char embeddings  slu_word_char_embs_with_slotembs.npy  w/ char and slot embs
    ...
    parser.add_argument("--example_emb_file", type=str, default="/data/sh/coachdata/snips/emb/example_embs_based_on_each_domain.dict", help="dictionary type: example embeddings based on each domain")
    ...
    # NER
    parser.add_argument("--ner_entity_type_emb_file", type=str, default="/data/sh/coachdata/ner/emb/entity_type_embs.npy", help="entity type embeddings file path")
    parser.add_argument("--ner_example_emb_file", type=str, default="/data/sh/coachdata/ner/emb/example_embs.npy", help="entity example embeddings file path")
