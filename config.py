...
def get_params():
    ...
    parser.add_argument("--dump_path", type=str, default="/home/sh/data/experiments", help="Experiment saved root path")
    ...
    parser.add_argument("--patience", type=int, default=5, help="trivial")
